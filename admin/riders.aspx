...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
                ...
                <head>
                    <meta charset="UTF-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Riders Management - RideNow Admin</title>
                    ...
                    <div class="container">
                            ...
                            <div class="page-header">
                                ...
                                <p class="page-subtitle">
                                    Manage all riders, view their details, ride history, and perform administrative actions</p>
                        </div>
                            ...
                            <div class="riders-table-container">
                                <div class="table-header">
                                    ...
                                    <a href="#" class="add-rider-btn"><i class="fa fa-plus"></i>Add New Rider </a>
                                </div>
                                        ...
                                        <tbody id="ridersTableBody">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="rider-info">
                                                        ...
                                                        <div class="rider-details">
                                                            ...
                                                            <small>ID: RDR001</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        jennifer.smith@email.com</div>
                                                ...
                                                <td>
                                                    <div>
                                                        127</div>
                                                    <small class="ride-history">Last ride: 2 days ago</small> </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="action-buttons">
                                                        <a href="#" class="btn-action btn-view" title="View Details"><i class="fa fa-eye"></i></a><a href="#" class="btn-action btn-edit" title="Edit Rider"><i class="fa fa-edit"></i></a><a href="#" class="btn-action btn-suspend" title="Suspend Rider"><i class="fa fa-ban"></i></a><a href="#" class="btn-action btn-delete" title="Delete Rider"><i class="fa fa-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="rider-info">
                                                        ...
                                                        <div class="rider-details">
                                                            ...
                                                            <small>ID: RDR002</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        michael.j@email.com</div>
                                                ...
                                                <td>
                                                    <div>
                                                        89</div>
                                                    <small class="ride-history">Last ride: 1 week ago</small> </td>
                                                <td>
                                                    <div class="total-spent">
                                                        $1,923.75</div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="rider-info">
                                                        ...
                                                        <div class="rider-details">
                                                            <h6>Sarah Brown</h6>
                                                            <small>ID: RDR003</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        sarah.brown@email.com</div>
                                                ...
                                                <td>
                                                    <div>
                                                        0</div>
                                                    <small class="ride-history">No rides yet</small> </td>
                                                <td>
                                                    <div class="total-spent">
                                                        $0.00</div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="action-buttons">
                                                        <a href="#" class="btn-action btn-view" title="View Details"><i class="fa fa-eye"></i></a><a href="#" class="btn-action btn-edit" title="Edit Rider"><i class="fa fa-edit"></i></a><a href="#" class="btn-action btn-activate" title="Activate Rider"><i class="fa fa-check"></i></a><a href="#" class="btn-action btn-delete" title="Delete Rider"><i class="fa fa-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="rider-info">
                                                        ...
                                                        <div class="rider-details">
                                                            ...
                                                            <small>ID: RDR004</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        chris.davis@email.com</div>
                                                ...
                                                <td>
                                                    <div>
                                                        45</div>
                                                    <small class="ride-history">Last ride: 1 month ago</small> </td>
                                                <td>
                                                    <div class="total-spent">
                                                        $1,156.20</div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="rider-info">
                                                        ...
                                                        <div class="rider-details">
                                                            <h6>Emily Wilson</h6>
                                                            <small>ID: RDR005</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        emily.wilson@email.com</div>
                                                ...
                                                <td>
                                                    <div>
                                                        203</div>
                                                    <small class="ride-history">Last ride: Yesterday</small> </td>
                                                <td>
                                                    <div class="total-spent">
                                                        $4,521.80</div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="rider-info">
                                                        ...
                                                        <div class="rider-details">
                                                            <h6>Robert Miller</h6>
                                                            <small>ID: RDR006</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        robert.miller@email.com</div>
                                                    <small>+1 (555) 678-9012</small> </td>
                                                <td><span class="status-badge status-active">Active</span></td>
                                                <td><span class="rating">★★★★☆ 4.7</span></td>
                                                <td>
                                                    <div>
                                                        156</div>
                                                    <small class="ride-history">Last ride: 3 days ago</small> </td>
                                                <td>
                                                    <div class="total-spent">
                                                        $3,247.90</div>
                                                </td>
